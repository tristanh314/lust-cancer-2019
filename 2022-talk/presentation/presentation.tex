...
\begin{frame}
    ...
    \end{equation*}
    \pause
    In this study, default values for \emph{overlap} were 0.5 for Part I and 0.6 for Part II. Merging was performed only once. For Part I, the resulting groups are called \emph{metagenes}.
\end{frame}
...
\begin{frame}
    ...
    \begin{block}{Part I}
        ...
        \begin{equation*}
            f(M) = n \cdot \frac{\left| E \right|}{n(n-1)}= \frac{\left| E \right|}{n-1}
        \end{equation*}
    \end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}[t] 
		...
		\begin{column}{0.45\textwidth}
			...
			\begin{itemize}
                \item Sig-Linda Jacobson
                \item John Eric Holmes (RIP)
            ...
            \begin{itemize}
                \item Doctor Frankenstein Jacobson
            \end{itemize}
		\end{column}
	\end{columns}
\end{frame}
